 ...
 */
function zenportfolio_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zenportfolio_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zenportfolio sample setting'),
  '#default_value' => theme_get_setting('zenportfolio_example'),
